   ...
   <parameterGroups>
      <parameterGroup>
         ...
         <isobaricLabels>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys127N</internalLabel>
               <terminalLabel>TMT10plex-Nter127N</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys127C</internalLabel>
               <terminalLabel>TMT10plex-Nter127C</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys128N</internalLabel>
               <terminalLabel>TMT10plex-Nter128N</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys128C</internalLabel>
               <terminalLabel>TMT10plex-Nter128C</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys129N</internalLabel>
               <terminalLabel>TMT10plex-Nter129N</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys129C</internalLabel>
               <terminalLabel>TMT10plex-Nter129C</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys130N</internalLabel>
               <terminalLabel>TMT10plex-Nter130N</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys130C</internalLabel>
               <terminalLabel>TMT10plex-Nter130C</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
            ...
            <IsobaricLabelInfo>
               <internalLabel>TMT10plex-Lys131N</internalLabel>
               <terminalLabel>TMT10plex-Nter131N</terminalLabel>
               <correctionFactorM2>0</correctionFactorM2>
               <correctionFactorM1>0</correctionFactorM1>
               <correctionFactorP1>0</correctionFactorP1>
               <correctionFactorP2>0</correctionFactorP2>
...
#Define func
def collectRawFiles(inputDir):
    if os.path.isdir(inputDir):
        print("Raw file input directory is: "+inputDir)
        fileList=os.listdir(inputDir)
        for fileName in fileList:
            if fileName.split(".")[-1] == "raw":
               fileNameList=fileName.split("_")
               tarDir=currentDir=os.path.dirname(os.path.abspath(__file__))+"\\workdata\\"+"_".join(fileNameList[0:2])
               if not os.path.exists(tarDir):
                  os.makedirs(tarDir)
               print("Copying: "+inputDir+"\\"+fileName+" ====> "+tarDir+"\\"+fileName)
               shutil.move(inputDir+"\\"+fileName, tarDir+"\\"+fileName)

def genParamFile(workDir, faFilePath):
   print("        Creating MaxQuant parameter file: "+workDir+"\mqpar.xml")
   paramFile=open(workDir+"\mqpar.xml", "w")
   rawFileList=os.listdir(workDir)       
   paramFile.write(cmdString1+"\n")
   paramFile.write("         <fastaFilePath>"+faFilePath+"</fastaFilePath>\n")
   paramFile.write(cmdString2+"\n")
   for rawFile in rawFileList:
      if rawFile.split(".")[-1] == "raw":
         paramFile.write("      <string>"+workDir+"\\"+rawFile+"</string>\n")
   paramFile.write(cmdString3+"\n")
   for rawFile in rawFileList:
      if rawFile.split(".")[-1] == "raw":
         experiments="MS3_"+"_".join(rawFile.split("_")[0:3])+"shift_1th_codon"
         paramFile.write("     <string>"+experiments+"</string>\n")
   paramFile.write(cmdString4+"\n")
   paramFile.close()

def mqAutoRun(inputDir, faFileDir):
   print("\n")
   print("**************************************************")
   print("*          MaxQuant atuo run script              *")
   print("*            [Yunnan University]                 *")
   print("**************************************************")
   print("\nCollecting raw files...\n")
   collectRawFiles(inputDir)
   currentDir=os.path.dirname(os.path.abspath(__file__))
   absWorkDataDir=currentDir+"\\workdata"
   print("\nMatching FA file and RAW file...")
   for faFile in os.listdir(faFileDir):
      if faFile.split(".")[-1] == "fa":
         absFaFilePath=faFileDir+"\\"+faFile
         faFileNameList=faFile.split("_")
         faFileNameListLow=faFile.lower().split(".")[0].split("_")
         workDirs=os.listdir(absWorkDataDir)
         for workDir in workDirs:
            workDirNameList=workDir.split("_")
            workDirNameListLow=workDir.lower().split("_")
            matchWord=[x for x in faFileNameListLow if x in workDirNameListLow]
            for match_w in matchWord:
               if "sample" in match_w and workDirNameListLow[0] == faFileNameListLow[0]:
                  print("\nMatched:"+"_".join(matchWord).upper())
                  print("        "+faFile+"  <===>  "+workDir)
                  absWorkDir=absWorkDataDir+"\\"+workDir
                  genParamFile(absWorkDir, absFaFilePath)
                  print("\nRunning system command...\n")
                  print("Change directory to: "+absWorkDir)
                  os.system("cd "+absWorkDir)
                  print("Running system command: 'D:\MaxQuant\\bin\MaxQuantCmd.exe "+absWorkDir+"\mqpar.xml'")
                  os.system("C:\\Users\\11386\\Desktop\\autorun\\MaxQuant\\bin\MaxQuantCmd.exe "+absWorkDir+"\mqpar.xml")
                  print("Go back to Directory: "+currentDir)
                  os.system("cd "+currentDir)
                  print("Finished task: "+workDir+"\mqpar.xml")
                  print("All data saved at: "+absWorkDataDir)

#Run below
#inputDir=sys.argv[1]
#faFileDir=sys.argv[2]
mqAutoRun(r'C:\\Users\\11386\\Desktop\\autorun\\test', r'C:\\Users\\11386\\Desktop\\autorun\\reference')
